...
import { IInvoiceAddedAsset } from "../../src/interfaces";

const defaultPassphrase: string = "passphrase";
...
export class TransactionFactory {
    ...
    public static invoiceAdded(
        invoiceAddedAsset: IInvoiceAddedAsset,
    ): TransactionFactory {
        const invoiceAddedBuilder = new InvoiceAddedBuilder();
        invoiceAddedBuilder.invoiceAddedData(invoiceAddedAsset);
        return new TransactionFactory(invoiceAddedBuilder);
    }
